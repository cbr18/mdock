...
func (h *Handler) routes() (http.Handler, error) {
	...
	r.Group(func(r chi.Router) {
		...
		r.Get("/api/vaults/{slug}/files", h.listFiles)
		r.Post("/api/vaults/{slug}/files", h.createFile)
		r.Delete("/api/vaults/{slug}/files", h.deletePath)
		r.Get("/api/vaults/{slug}/files/content", h.readFileContent)
		r.Put("/api/vaults/{slug}/files/content", h.writeFileContent)
		r.Post("/api/vaults/{slug}/dirs", h.createDir)
		r.Patch("/api/vaults/{slug}/files/move", h.movePath)
		r.Post("/api/vaults/{slug}/locks", h.acquireFileLock)
		r.Post("/api/vaults/{slug}/locks/heartbeat", h.heartbeatFileLock)
		...
		r.Post("/api/vaults/{slug}/git/restore", h.restoreGitFile)
		r.Get("/api/vaults/{slug}/git/snapshots", h.listSnapshots)
		r.Post("/api/vaults/{slug}/git/snapshot", h.createSnapshot)
